...
function city_country0(city: string, country: string): string {
    return `${city}, ${country}`;
}

// Call the function with different city-country pairs
let city1 = city_country0("Lahore", "Pakistan");
let city2 = city_country0("London", "United Kingdom");
let city3 = city_country0("Sydney", "Australia");
